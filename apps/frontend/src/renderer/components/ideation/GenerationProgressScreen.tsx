        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <Badge variant="outline">
                {t('ideation:progress.complete', { completed: completedCount, total: enabledTypes.length })}
              </Badge>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Tooltip>
              ...
              <TooltipContent>{t('ideation:progress.stopGeneration')}</TooltipContent>
            </Tooltip>
          </div>
        </div>
                ...
                <div className="grid gap-3">
                  ...
                  {state === 'pending' && (
                    <div className="text-sm text-muted-foreground py-2">
                      {t('ideation:progress.waitingToStart')}
                    </div>
                  )}
                  ...
                  {state === 'failed' && ideas.length === 0 && (
                    <div className="text-sm text-destructive py-2">
                      {t('ideation:progress.failedToGenerate')}
                    </div>
                  )}
                  ...
                  {state === 'completed' && ideas.length === 0 && (
                    <div className="text-sm text-muted-foreground py-2">
                      {t('ideation:progress.noIdeasGenerated')}
                    </div>
                  )}
                </div>
              </div>
