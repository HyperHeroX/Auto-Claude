      ...
      <Dialog open={showConfigDialog} onOpenChange={onCloseConfigDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {t('ideation:configDescription')}
            </DialogDescription>
          </DialogHeader>
          <div className="py-4 space-y-4 max-h-96 overflow-y-auto">
            <div className="space-y-3">
              <h4 className="text-sm font-medium">{t('ideation:dialogs.ideationTypes')}</h4>
          ...
          <div className="py-4 space-y-3 max-h-96 overflow-y-auto">
            {availableTypesToAdd.length === 0 ? (
              <div className="text-center py-6 text-muted-foreground">
                ...
                <p>{t('ideation:allTypesGenerated')}</p>
                <p className="text-sm mt-1">{t('ideation:useRegenerateHint')}</p>
              </div>
            ) : (
