          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {gitHistoryType === 'recent' && (
                <div className="space-y-2">
                  <Label className="text-xs">{t('changelog:numCommits')}</Label>
                  <Input
                    type="number"
                    min={1}
                    max={500}
              ...
              {gitHistoryType === 'since-version' && (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {t('changelog:filters.allCommitsSinceDesc')}
                  </p>
                </div>
              )}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('changelog:filters.mergingIntoDesc')}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {t('changelog:filters.branchWithChangesDesc')}
                </p>
              </div>
