    ...
    <>
      ...
      {project.autoBuildPath && (
        <>
          ...
          {/* Agent Settings */}
          <section className="space-y-4">
            <h3 className="text-sm font-semibold text-foreground">{t('settings:agentConfig.title')}</h3>
            <div className="space-y-2">
              <Label htmlFor="model" className="text-sm font-medium text-foreground">{t('settings:agentConfig.model')}</Label>
              <Select
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <Label className="font-normal text-foreground">{t('settings:notifications.onTaskComplete')}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="font-normal text-foreground">{t('settings:notifications.onTaskFailed')}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="font-normal text-foreground">{t('settings:notifications.onReviewNeeded')}</Label>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <Label className="font-normal text-foreground">{t('settings:notifications.sound')}</Label>
                <Switch
